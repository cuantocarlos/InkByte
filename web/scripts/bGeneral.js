...
export function compruebaNombre(nombre){
  ...
  httpRequest.open('POST','http://localhost/InkCasa/InkByte/web/index.php?ctl=usuarioUnico',true);   //ACORDARSE DE CAMBIAR LA RUTA ABSOLUTA SI SE SUBE A OTRO SITIO
...
export function compruebaCorreo(mail){
  ...
  httpRequest.open('POST','http://localhost/InkCasa/InkByte/web/index.php?ctl=mailUnico',true);   //ACORDARSE DE CAMBIAR LA RUTA ABSOLUTA SI SE SUBE A OTRO SITIO
