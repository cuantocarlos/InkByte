  ...
  <div class="d-flex  pt-3 contenedorPerfil gap-4">
    <div class="d-flex px-5 flex-wrap fotografia" style="border: 2px solid rgba(255, 228, 225, 0.9);">
      ...
      <div class="d-flex align-items-center justify-content-center mb-3">
        ...
        <div class="d-none" id="nivel_usuario">
...
?>
  ...
  <div class="d-flex gap-5 descripcion">
    <div class="d-flex justify-content-start align-items-start p-3 flex-column mt-5 flex-grow-1"
      style="border: 2px solid rgba(255, 228, 225, 0.9);">
      <h4>Descripción:</h4>
      ...
      <div class="modal-content">
        ...
        <form action="index.php?ctl=cambiaPass" method="POST" class="mt-4">
          <div class="form-floating mx-5">
            ...
            <div class="mb-4 mx-5-md mx-5-lg">La contraseña debe contener: <span id="mayus" class="">1 Mayúscula</span>,
              <span id="minus" class="">1 minúscula</span>, <span id="num" class="">1 número</span>, <span id="especial"
                class="">1 carácter especial</span>. <span id="longitud" class="">Entre 8 y 16 caracteres</span></div>
          </div>
          ...
          <div class="form-floating mx-5">
            <input type="password" class="form-control rounded-3" placeholder="Password" name="oldPass" id="oldPass"
              required>
            <label for="oldPass">Contraseña</label>
          </div>

          <?php if ($_SESSION["mensaje"] !== ""): ?>
          <div id="oldMal" class="mb-4 text-danger mx-5 px-3">
      ...
      <div class="modal-content">
        ...
        <form action="index.php?ctl=modificaUsuario" method="POST" class="p-4 " enctype=multipart/form-data>
          ...
          <div class="d-flex flex-row me-4 mb-2">
            ...
            <div class="d-flex justify-content-center align-items-center flex-column">
              <div class="input-group">
                ...
                <input type="text" class="form-control" aria-describedby="basic-addon1" id="nombre"
          ...
          <div class="form-floating">
            <textarea class="form-control" placeholder="descripción" id="descripcion" style="height: 100px"
              name="descripcion"><?php echo $_SESSION["descripcion"] ?></textarea>
  ...
  <div class="container d-flex py-5 gap-3 justify-content-center align-items-center mt-1 flex-wrap">
    ...
    <!--Terror -->
    <input type="checkbox" class="btn-check terror" id="terror" autocomplete="off" name="generoUsuario[]"
      value="terror">
    <label class="btn btn-outline-primary terror-label" for="terror">Terror</label>
    <!-- Romance -->
    <input type="checkbox" class="btn-check romance" id="romance" autocomplete="off" name="generoUsuario[]"
      value="romance">
    <label class="btn btn-outline-primary romance-label" for="romance">Romance</label>


    <!-- Fantasía -->
    <input type="checkbox" class="btn-check fantasia" id="fantasia" autocomplete="off" name="generoUsuario[]"
      value="fantasia">
    <label class="btn btn-outline-primary fantasia-label" for="fantasia">Fantasía</label>
    <!-- Ciencia Ficción -->
    <input type="checkbox" class="btn-check cficcion" id="cficcion" autocomplete="off" name="generoUsuario[]"
      value="cficcion">
    ...
    <!-- Historia -->
    <input type="checkbox" class="btn-check historia" id="historia" autocomplete="off" name="generoUsuario[]"
      value="historia">
    ...
    <!-- Thriller -->
    <input type="checkbox" class="btn-check thriller" id="thriller" autocomplete="off" name="generoUsuario[]"
      value="thriller">
    <label class="btn btn-outline-primary thriller-label" for="thriller">Thriller</label>
    <!-- Poesía -->
    <input type="checkbox" class="btn-check poesia" id="poesia" autocomplete="off" name="generoUsuario[]"
      value="poesia">
    ...
    <!-- Biografía -->
    <input type="checkbox" class="btn-check biografia" id="biografia" autocomplete="off" name="generoUsuario[]"
      value="biografia">
    ...
    <!-- Misterio -->
    <input type="checkbox" class="btn-check misterio" id="misterio" autocomplete="off" name="generoUsuario[]"
      value="misterio">
    <label class="btn btn-outline-primary misterio-label" for="misterio">Misterio</label>
    <!-- Policíaca -->
    <input type="checkbox" class="btn-check policiaca" id="policiaca" autocomplete="off" name="generoUsuario[]"
      value="policiaca">
