    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <form action="index.php?ctl=buscarLibros" method="post" class="d-flex search-form-desktop ms-auto mt-3">
                <input class="form-control me-2" name="buscar_libro" id="buscar_libro" type="search"
                    placeholder="Busca tu libro" aria-label="Search">
                <button class="btn btn-outline-success" name="boton_buscar" id="boton_buscar"
            ...
            <div class="nav-item dropdown ms-3">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown"
                    ...
                    <img src='../app/archivos/img/perfil/<?php echo $_SESSION["foto_perfil"]; ?>' alt="f_perfil"
