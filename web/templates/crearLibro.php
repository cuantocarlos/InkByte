<div class="container d-flex flex-column mt-5">
    ...
    <form action="index.php?ctl=crearLibro" method="post" enctype="multipart/form-data">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control rounded-3" id="titulo_lib" name="titulo_lib" placeholder="Título del capítulo*" />
            <label for="nombre">Título*</label>
        </div>

        <small class="text-body-secondary mb-1">Máximo 500 caracteres.</small>
        <div class="form-floating mb-3">
            <textarea class="form-control" placeholder="Añade una sinopsis" id="sinopsis" style="height: 100px;" name="sinopsis"></textarea>
