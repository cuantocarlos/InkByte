...
DROP DATABASE IF EXISTS inkbyte;
CREATE DATABASE inkbyte DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE inkbyte;
...
-- DATOS FALSOS
-- Usuario1
INSERT INTO Usuario (nombre, nick, email, pass, f_nacimiento, foto_perfil, descripcion, nivel, activo)-- PW: a1Ahabxt57wbwdd.
VALUES ('Alfredo García','operadornuclear',"garcia@endesa.es",'$2y$10$BAuYcpZ3i4wzV7RWliOZ4efznlorbOMgyDiVwmkTcAi9cqJuuLFZG','1980-01-01','1.jpeg','Me gusta divulgar ciencia y el deporte.',2,1);
-- Usuario2
...
INSERT INTO Libro (id_user, titulo, sinopsis, imagen_portada, capitulos, num_resenas, valoracion, visitas, visitasSemana, estado)
VALUES
    (1, 'Geoestrategia de la bombilla: Energía nuclear para un cielo limpio', 'La humanidad se enfrenta a la titánica tarea de conseguir un sistema energético que cubra sus necesidades, que sea sostenible, respetuoso con el medio ambiente y la salud de las personas, y que al mismo tiempo sea asequible para tener un alcance universal. No existen soluciones mágicas en ingeniería, sino soluciones de compromiso en las que se analizan las ventajas e inconvenientes de cada una y se busca un equilibrio.', 'bombilla.jpg', 0, 0, 5, 80, 60, 1),
    (2, 'El guardián entre el centeno', 'La historia sigue a Holden Caulfield, un adolescente en Nueva York, tras ser expulsado de la escuela y sus aventuras.', 'centeno.jpg', 25, 150, 4.5, 20, 500, 1),
    (3, 'Cien años de soledad', 'La historia de la familia Buendía y sus generaciones, situada en el ficticio pueblo de Macondo.', 'soledad.jpg', 20, 200, 4.8, 5000, 800, 1),
    (3, 'Orgullo y prejuicio', 'La historia sigue los romances de las hermanas Bennet, especialmente el de Elizabeth Bennet y el Sr. Darcy.', 'orgullo.jpg', 30, 180, 4.7, 4500, 700, 1),
    (4, '1984', 'La novela distópica de George Orwell que sigue la vida de Winston Smith, quien vive en una sociedad totalitaria.', '1984.jpg', 35, 220, 4.6, 4000, 600, 1),
    (5, 'Matar un ruiseñor', 'La historia de Scout Finch, una niña en Alabama, y su padre, el abogado Atticus Finch, quien defiende a un hombre negro acusado de violar a una mujer blanca.', 'ruiseñor.jpg', 28, 190, 4.9, 6000, 900, 1);
