...
public static $dir_usuario=__DIR__.DIRECTORY_SEPARATOR."../archivos/imgPerfil".DIRECTORY_SEPARATOR;
public static $dir_usuarioLayoutPerfil="/InkByte/app/archivos/img/perfil/";
